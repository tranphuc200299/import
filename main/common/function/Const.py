...
FILENM_TMP = ".tmp"
FTPFILE = "ftpput.ftp"
FTPLOGFILE = "ftpput.log"
FTPBATFILE = "ftpput.bat"
...
rtnProcNF = 2  # 該当データなし
rtnProcDP = 3  # 該当データあり
rtnProcIniOK = 0  # '初期設定ファイル取得成功
rtnProcIniNG = 2  # '初期設定ファイル取得失敗
csBiko300_001_S = 0  # 'スタート位置
csBiko300_001_M = 3  # '桁数
csOKDir = 1  # '電文ファイル正常フォルダに移動
csNGDir = 2  # '電文ファイル異常フォルダに移動
rtnOraSErr = -1  # 'オラクルエラー(セッション系)
rtnOraDErr = -2  # 'オラクルエラー(DBアクセス系)
rtnOraOErr = -3  # 'オラクル以外エラー
rtnOraLock = -5  # '該当データロック中
